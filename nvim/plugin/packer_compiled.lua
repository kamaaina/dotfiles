...
_G.packer_plugins = {
  ...
  ["coc-rust-analyzer"] = {
    loaded = true,
    path = "/home/mike/.local/share/nvim/site/pack/packer/start/coc-rust-analyzer",
    url = "https://github.com/fannheyward/coc-rust-analyzer"
  },
  ["coc.nvim"] = {
    loaded = true,
    path = "/home/mike/.local/share/nvim/site/pack/packer/start/coc.nvim",
  ...
  ["iceberg.vim"] = {
    loaded = true,
    path = "/home/mike/.local/share/nvim/site/pack/packer/start/iceberg.vim",
  ...
  ["ron.vim"] = {
    loaded = true,
    path = "/home/mike/.local/share/nvim/site/pack/packer/start/ron.vim",
  ...
  ["vim-css-color"] = {
    loaded = true,
    path = "/home/mike/.local/share/nvim/site/pack/packer/start/vim-css-color",
    url = "https://github.com/ap/vim-css-color"
  },
  ["vim-highlightedyank"] = {
    loaded = true,
    path = "/home/mike/.local/share/nvim/site/pack/packer/start/vim-highlightedyank",
